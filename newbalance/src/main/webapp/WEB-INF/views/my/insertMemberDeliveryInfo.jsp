 	...
 	<div class="addDelivery">
                <div class="formArea">
                    <fieldset>
                        ...
                        <div class="rrow">
                            ...
                            <div class="ffdata">
                                <input type="text" id="maName" name="maName" class="ipTextLg" title="아이디">
                            </div>
                        </div>
                        <div class="rrow">
                ...
                <div class="rrow">
                    ...
                    <div class="ffdata">
                        ...
                        <div class="block">
                        	<input type="text" class="ipTextSm" id="maZipcode" name="maZipcode" readonly title="배송지 우편번호" value="" maxlength="6">
                        </div>
						<input type="text" class="ipTextXl" id="maAddress1" name="maAddress1" readonly title="기본 주소" value="" maxlength="120">
						<input type="text" class="ipTextXl" id="maAddress2" name="maAddress2" title="상세 주소" value="" maxlength="120">
                    </div>
                </div>
                        <div class="chk_right">
                        <input type="checkbox" id="maDefault" name="maDefault" class="ipChekbox" value="1">
...
$(window.document).ready(function(){
	...
	$("#postFind").click(function(){
		popupDaumPost($("#maZipcode"), $("#maAddress1"), $("#maAddress2"));
	});
